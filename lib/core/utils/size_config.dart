...
class SizeConfig {
  //default parameters set as per iPhone 14 dimensions
  static double _defaultScreenWidth = 390;
  static double _defaultScreenHeight = 844;
...
class SizeConfiguration extends StatelessWidget {
  const SizeConfiguration({super.key, required this.builder, this.designSize});
