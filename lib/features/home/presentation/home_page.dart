    ...
    return Scaffold(
      ...
      body: CustomScrollView(
        ...
        slivers: [
            ...
            child: Stack(
              children: [
                HeroBackground(
                  ...
                  bannerUrl: dummyManga[_currentHeroIndex % dummyManga.length]
                      ['bannerUrl'],
                ),
                Column(
                  children: [
                    ...
                    Padding(
                      ...
                      child: Row(
                        children: [
                          CategoryCard(
                              title: 'GENRES', imageUrl: AssetPath.bannerTwo),
          ...
          // Trending Sections
          SliverToBoxAdapter(child: _buildSection('Trending Manga')),
          SliverToBoxAdapter(child: _buildSection('Trending Manhwa')),
          SliverToBoxAdapter(child: _buildSection('Trending Novel')),
          SliverToBoxAdapter(child: _buildSection('Top rated')),
          SliverToBoxAdapter(child: _buildSection('Most Favourite')),
